...
from .utils_eval import interpolated_prec_rec, segment_iou
...
class ANETdetection(object):
    ...
    def _get_predictions_with_label(self, prediction_by_label, label_name, cidx):
        ...
        try:
            ...
            if self.verbose:
                print(
                    "Warning: No predictions of label '%s' were provdied." % label_name
                )
            return pd.DataFrame()
    ...
    def evaluate(self):
        ...
        print(
            "|t-IoU |{}|".format(
                "||".join(["{:.3f}".format(item) for item in self.tiou_thresholds])
            )
        )
        print(
            "-------------------------------------------------------------------------------"
        ...
        print(
            "|mAP   |{}|".format(
                "||".join(["{:.3f}".format(item) for item in self.mAP])
            )
        )
        print(
            "-------------------------------------------------------------------------------"
        ...
        print(
            "|Average-mAP: {:.4f} Average mAP[0.1:0.5]:{:.4f} Average mAP[0.3:0.7]:{:.4f}".format(
                self.average_mAP, self.mAP[:5].mean(), self.mAP[2:7].mean()
            )
        )
        print(
            "-------------------------------------------------------------------------------"
